      ...
      <div className="relative">
        <div className="mb-3 flex items-center gap-2">
          ...
          <div>
            ...
            <div className="font-display text-lg text-ink">Personalised guidance</div>
          </div>
        </div>
        ...
        {sources && sources.length > 0 && (
          <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-ink/5 pt-4">
            <span className="font-mono text-[10px] uppercase tracking-wider text-muted">Sources</span>
            {sources.map((s, i) => {
